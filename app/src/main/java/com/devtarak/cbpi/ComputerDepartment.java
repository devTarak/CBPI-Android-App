...
public class ComputerDepartment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cmtCall1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ClickRedirectCst("tel:+8801962823150");
            }
        });
        cmtCall2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ClickRedirectCst("tel:+8801719508316");
            }
        });
        cmtCall3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ClickRedirectCst("tel:+8801721153960");
            }
        });
        cmtCall4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ClickRedirectCst("tel:+8801868672498");
            }
        });
        cmtMail1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ClickRedirectCst("mailto:pravas.kanti.dey@gmail.com");
            }
        });
        cmtMail2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ClickRedirectCst("mailto:mrana130@gmail.com");
            }
        });
        cmtMail3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ClickRedirectCst("mailto:abc@gmail.com");
            }
        });
        cmtMail4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ClickRedirectCst("mailto:sarif914101@gmail.com");
            }
        });
